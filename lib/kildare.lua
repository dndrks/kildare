...
function Kildare.init(poly)
  ...
  kildare_drum_params = {
    ...
    ["saw"] = {
      ...
      {id = 'subAmp', name = 'sub amp', type = 'control', min = 0, max = 1.25, warp = 'lin', default = 1, quantum = 1/125, formatter = function(param) return (round_form((type(param) == 'table' and param:get() or param)*100,1,"%")) end},
      {id = 'subPw', name = 'sub pw', type = 'control', min = 0, max = 1, warp = 'lin', default = 0.5, quantum = 0.01, formatter = function(param) return (round_form((type(param) == 'table' and param:get() or param)*100,1,"%")) end},
      {type = 'separator', name = 'modulator'},
      {id = 'modAmp', name = 'modulator presence', type = 'control', min = 0, max = 1, warp = 'lin', default = 0, formatter = function(param) return (round_form((type(param) == 'table' and param:get() or param)*100,1,"%")) end},
      {id = 'modHz', name = 'modulator freq', type = 'control', min = 20, max = 24000, warp = 'exp', default = 600, formatter = function(param) return (round_form((type(param) == 'table' and param:get() or param),0.01," Hz")) end},
      {id = 'modFollow', name = '--> freq from carrier?', type = 'control', warp = 'lin', min = 0, max = 1, default = 0,  step = 1, quantum = 1, formatter = function(param) if (type(param) == 'table' and param:get() or param) == 0 then return ("no") else return ("yes") end end},
  ...
  kildare_fx_params = {
    ...
    ["feedback"] = {
      ...
      {id = 'aProcess_shiftFreq', name = 'A frequency shift', type = 'control', min = 0, max = 12000, warp = 'lin', default = 0, formatter = function(param) return (round_form((type(param) == 'table' and param:get() or param),0.01," Hz")) end},
      ...
      {id = 'bProcess_shiftFreq', name = 'B frequency shift', type = 'control', min = 0, max = 12000, warp = 'lin', default = 0, formatter = function(param) return (round_form((type(param) == 'table' and param:get() or param),0.01," Hz")) end},
      ...
      {id = 'cProcess_shiftFreq', name = 'C frequency shift', type = 'control', min = 0, max = 12000, warp = 'lin', default = 0, formatter = function(param) return (round_form((type(param) == 'table' and param:get() or param),0.01," Hz")) end},
