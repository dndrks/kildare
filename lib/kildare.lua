...
function Kildare.init(poly)
  ...
  local sample_params = {
    ...
    {id = 'playbackRateBase', name = 'rate', type = 'control', min = 1, max = 11, warp = 'lin', default = 9, step = 1, quantum = 1/10, formatter = function(param) local rate_options = {-4, -2, -1, -0.5, -0.25, 0, 0.25, 0.5, 1, 2, 4} return rate_options[param:get()]..'x' end},
    {id = 'playbackRateOffset', name = 'offset', type = 'control', min = -24, max = 24, warp = 'lin', default = 0, step = 1, quantum = 1/48, formatter = function(param) return (round_form(param:get(),1," semitones")) end},
    ...
    {id = 'delayEnv', name = 'delay envelope', type = 'control', min = 0, max = 1, warp = "lin", default = 0,  step = 1, quantum = 1, formatter = function(param) local modes = {"off","on"} return modes[param:get()+1] end},
  ...
  kildare_drum_params = {
    ["bd"] = {
      ...
      {id = 'poly', name = 'polyphony', type = 'control', min = 1, max = 2, warp = "lin", default = 1, quantum = 1,  step = 1, formatter = function(param) local modes = {"mono","poly"} return modes[param:get()] end},
      ...
      {id = 'carDetune', name = 'detune', type = 'control', min = -12, max = 12, warp = 'lin', default = 0,  step = 1/10, quantum = 1/240, formatter = function(param) return (round_form(param:get(),0.1," semitones")) end},
    ...
    ["sd"] = {
      ...
      {id = 'carHz', name = 'carrier freq', type = 'control', min = 46, max = 76, default = 61, warp = 'lin',  step = 1, formatter = function(param) return (musicutil.note_num_to_name(param:get(),true)) end},
      {id = 'carDetune', name = 'detune', type = 'control', min = -12, max = 12, warp = 'lin',  step = 1/10, default = 0, quantum = 1/240, formatter = function(param) return (round_form(param:get(),0.1," semitones")) end},
      {id = 'carAtk', name = 'carrier attack', type = 'control', min = 0.001, max = 10, warp = 'exp', default = 0, formatter = function(param) return (round_form(param:get(),0.01," s")) end},
    ...
    ["tm"] = {
      {type = 'separator', name = 'carrier'},
      {id = 'poly', name = 'polyphony', type = 'control', min = 1, max = 2, warp = "lin", default = 1,  step = 1, quantum = 1, formatter = function(param) local modes = {"mono","poly"} return modes[param:get()] end},
      {id = 'amp', name = 'carrier amp', type = 'control', min = 0, max = 1.25, warp = 'lin', default = 0.6, quantum = 1/125, formatter = function(param) return (round_form(param:get()*100,1,"%")) end},
      {id = 'carHz', name = 'carrier freq', type = 'control', min = 27, max = 55, default = 41,  step = 1, warp = 'lin', formatter = function(param) return (musicutil.note_num_to_name(param:get(),true)) end},
      {id = 'carDetune', name = 'detune', type = 'control', min = -12, max = 12, warp = 'lin',  step = 1/10, default = 0, quantum = 1/240, formatter = function(param) return (round_form(param:get(),0.1," semitones")) end},
      {id = 'carAtk', name = 'carrier attack', type = 'control', min = 0.001, max = 10, warp = 'exp', default = 0, formatter = function(param) return (round_form(param:get(),0.01," s")) end},
    ...
    ["cp"] = {
      ...
      {id = 'poly', name = 'polyphony', type = 'control', min = 1, max = 2, warp = "lin", default = 1,  step = 1, quantum = 1, formatter = function(param) local modes = {"mono","poly"} return modes[param:get()] end},
      {id = 'amp', name = 'carrier amp', type = 'control', min = 0, max = 1.25, warp = 'lin', default = 0.6, quantum = 1/125, formatter = function(param) return (round_form(param:get()*100,1,"%")) end},
      {id = 'carHz', name = 'carrier freq', type = 'control', min = 47, max = 111, default = 91,  step = 1, warp = 'lin', formatter = function(param) return (musicutil.note_num_to_name(param:get(),true)) end},
      {id = 'carDetune', name = 'detune', type = 'control', min = -12, max = 12, warp = 'lin',  step = 1/10, default = 0, quantum = 1/240, formatter = function(param) return (round_form(param:get(),0.1," semitones")) end},
      {id = 'carRel', name = 'carrier release', type = 'control', min = 0.001, max = 10, warp = 'exp', default = 0.43, formatter = function(param) return (round_form(param:get(),0.01," s")) end},
      {type = 'separator', name = 'modulator'},
    ...
    ["rs"] = {
      {type = 'separator', name = 'carrier'},
      {id = 'poly', name = 'polyphony', type = 'control', min = 1, max = 2, warp = "lin",  step = 1, default = 1, quantum = 1, formatter = function(param) local modes = {"mono","poly"} return modes[param:get()] end},
      ...
      {id = 'carHz', name = 'carrier freq', type = 'control', min = 55, max = 105, default = 66,  step = 1, warp = 'lin', formatter = function(param) return (musicutil.note_num_to_name(param:get(),true)) end},
      {id = 'carDetune', name = 'detune', type = 'control', min = -12, max = 12, warp = 'lin',  step = 1/10, default = 0, quantum = 1/240, formatter = function(param) return (round_form(param:get(),0.1," semitones")) end},
      {id = 'carAtk', name = 'carrier attack', type = 'control', min = 0.001, max = 10, warp = 'exp', default = 0, formatter = function(param) return (round_form(param:get(),0.01," s")) end},
    ...
    ["cb"] = {
      ...
      {id = 'carHz', name = 'carrier freq', type = 'control', min = 55, max = 105,  step = 1, default = 68, warp = 'lin', formatter = function(param) return (musicutil.note_num_to_name(param:get(),true)) end},
      {id = 'carDetune', name = 'detune', type = 'control', min = -12, max = 12,  step = 1/10, warp = 'lin', default = 0, quantum = 1/240, formatter = function(param) return (round_form(param:get(),0.1," semitones")) end},
      {id = 'carAtk', name = 'carrier attack', type = 'control', min = 0.001, max = 10, warp = 'exp', default = 0, formatter = function(param) return (round_form(param:get(),0.01," s")) end},
      {id = 'carRel', name = 'carrier release', type = 'control', min = 0.001, max = 10, warp = 'exp', default = 0.15, formatter = function(param) return (round_form(param:get(),0.01," s")) end},
      {type = 'separator', name = 'modulator'},
      {id = 'feedAmp', name = 'modulator feedback', type = 'control', min = 0, max = 1, warp = 'lin', default = 0, formatter = function(param) return (round_form(param:get()*100,1,"%")) end},
    ...
    ["hh"] = {
      ...
      {id = 'poly', name = 'polyphony', type = 'control', min = 1, max = 2, warp = "lin",  step = 1, default = 1, quantum = 1, formatter = function(param) local modes = {"mono","poly"} return modes[param:get()] end},
      {id = 'amp', name = 'carrier amp', type = 'control', min = 0, max = 1.25, warp = 'lin', default = 0.6, quantum = 1/125, formatter = function(param) return (round_form(param:get()*100,1,"%")) end},
      {id = 'carHz', name = 'carrier freq', type = 'control', min = 55, max = 89, default = 55,  step = 1, warp = 'lin', formatter = function(param) return (musicutil.note_num_to_name(param:get(),true)) end},
      {id = 'carDetune', name = 'detune', type = 'control', min = -12, max = 12, warp = 'lin',  step = 1/10, default = 0, quantum = 1/240, formatter = function(param) return (round_form(param:get(),0.1," semitones")) end},
      {id = 'carAtk', name = 'carrier attack', type = 'control', min = 0.001, max = 10, warp = 'exp', default = 0, formatter = function(param) return (round_form(param:get(),0.01," s")) end},
