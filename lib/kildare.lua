...
function Kildare.init()
  ...
  drum_params = {
    ...
    ["sd"] = {
      {type = 'separator', name = 'carrier'},
      {id = 'amp', name = 'carrier amp', type = 'control', min = 0, max = 1, warp = 'lin', default = 0.25, formatter = function(param) return (round_form(param:get()*100,1,"%")) end},
      {id = 'carHz', name = 'carrier freq', type = 'control', min = 123, max = 660, warp = 'exp', default = 293.7, formatter = function(param) return (round_form(param:get(),0.01," hz")) end},
      {id = 'carAtk', name = 'carrier attack', type = 'control', min = 0.001, max = 10, warp = 'exp', default = 0, formatter = function(param) return (round_form(param:get(),0.01," s")) end},
      {id = 'carRel', name = 'carrier release', type = 'control', min = 0.001, max = 10, warp = 'exp', default = 0.3, formatter = function(param) return (round_form(param:get(),0.01," s")) end},
      {type = 'separator', name = 'modulator'},
      {id = 'modAmp', name = 'modulator presence', type = 'control', min = 0, max = 1, warp = 'lin', default = 0, formatter = function(param) return (round_form(param:get()*100,1,"%")) end},
    ...
    ["xt"] = {
      {type = 'separator', name = 'carrier'},
      {id = 'amp', name = 'carrier amp', type = 'control', min = 0, max = 5, warp = 'lin', default = 0.4, formatter = function(param) return (round_form(param:get()*100,1,"%")) end},
      ...
      {id = 'modAtk', name = 'modulator attack', type = 'control', min = 0.001, max = 10, warp = 'exp', default = 0.001, formatter = function(param) return (round_form(param:get(),0.01," s")) end},
      {id = 'modRel', name = 'modulator release', type = 'control', min = 0.001, max = 10, warp = 'exp', default = 0.08, formatter = function(param) return (round_form(param:get(),0.01," s")) end},
    ...
    ["rs"] = {
      ...
      {id = 'sdAmp', name = 'snare amp', type = 'control', min = 0, max = 5, warp = 'lin', default = 1, formatter = function(param) return (round_form(param:get()*100,1,"%")) end},
